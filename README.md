...
- [Gemmi](https://github.com/project-gemmi/gemmi/releases/tag/v0.3.3) - v0.3.3

1. Clone the current repository
2. Download the specific versions above
3. Rename the folders if needed with the names above (Eigen-3.3.7, CGAL-4.14.3, Gemmi)
